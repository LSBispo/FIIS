...
# Scatter plot com tamanho proporcional à quantidade
s = df_compras['Quantidade'] * 10  # Ajuste o fator de escala conforme necessário
plt.scatter(df_compras['Data'], df_compras['Preço'], c='red', label='Compra', marker='o', s=s)

# Adicionar anotações com a quantidade de compra aos pontos de compra
for i, row in df_compras.iterrows():
    plt.annotate(f'{row["Quantidade"]:.0f}', (row['Data'], row['Preço']), textcoords="offset points", xytext=(0,10), ha='center')
